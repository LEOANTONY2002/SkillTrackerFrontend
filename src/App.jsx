          ...
          <div className="ad-toggle">
            <img
              ...
              style={
                admin
                  ? {
                      background: "linear-gradient(120deg, #fc3737a4, red)",
                      boxShadow: "0 2px 15px rgba(255, 170, 170, 0.717)",
                    }
                  : {}
              }
              src={`https://img.icons8.com/fluency-systems-regular/48/${
                admin ? "ffffff" : "fc3737"
              }/system-administrator-male.png`}
              alt=""
            />
            <img
