...
function Profile() {
  ...
  //   setLoading(true);
  //   if (skills) {
  //     let allSkills = skills?.map((skill) => skill?.skill?.name);
  //     let employeeSkills = user?.employeeSkills?.map(
  ...
  return (
    <>
      <div className="e-profile">
        <div className="ep-head">
          <img
            style={
              user?.photo === ""
                ? { padding: "20px", width: "30px !important" }
                : { padding: "0" }
            }
            src={
              !user.photo
              ...
              <div className="es-card">
                ...
                {es?.certificate && (
                  <div className="s-cert">
                    ...
                    >
                      <img
                        src="https://img.icons8.com/fluency-systems-regular/60/fc3737/certificate.png"
                        alt=""
                      />
                    </div>
                  </div>
        ...
        {/* {loading ? (
          ...
          recommendedCourses?.length !== 0 && (
            <div className="ep-rec">
              <h5>
                Recommended Skills & Courses <span></span>{" "}
              </h5>
              <main>
                {recommendedCourses?.map((rc) => (
                  <div key={rc?.course_title} className="es-card">
                    <div style={{ width: "200px" }} className="eb-skill">
                      <div className="ebs-head">
                        <img
                          src="https://img.icons8.com/fluency-systems-filled/48/fc3737/online-group-studying.png"
                          alt=""
                        ...
                        <div>
                          ...
                          <span style={{ marginTop: "5px" }}>
                            {rc?.course_organization}
                          </span>
                        </div>
                      </div>
                      <h5 style={{ color: "red", margin: "10px 0" }}>
                        {rc?.skill}
                      </h5>
                      <h6 style={{ marginBottom: "10px" }}>
                        {rc?.course_difficulty}
                      </h6>
                    </div>
                  </div>
                ))}
          ...
          <div className="login">
            <div>
              ...
              <div className="l-head">
                <img
                  src="https://img.icons8.com/material-rounded/40/fc3737/password1.png"
                  alt=""
                />
                <span></span>
                <p>Reset Password</p>
      ...
      <div style={{ zIndex: 0 }} className="p-pw-reset">
        <img
