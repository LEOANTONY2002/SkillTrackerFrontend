          ...
          <div className="sa-body">
            <div style={{ gap: "25px" }}>
              {skill?.skills.length !== 0 ? (
                skill?.skills?.map((es) => (
                  <div onClick={() => delSkill(es.id)} className="delete-skill">
                    <div>
                      <div>
                    ...
                    <img
                      src="https://img.icons8.com/fluency-systems-regular/48/ffffff/delete.png"
                      alt=""
                    />
                  </div>
                ))
              ) : (
                <h6 style={{ margin: "30px 0", color: "lightgray" }}>
                  Add your skills
                </h6>
              )}
            </div>
                ...
                skills?.map((cos) => (
                  <div className="sab">
                    ...
                    <div className="sab-exp">
                      <p onClick={() => addSkill(cos?.id, "MINIMAL", cos)}>
                        Minimal
                      </p>
                      <p onClick={() => addSkill(cos?.id, "BEGINNER", cos)}>
                        Beginner
                      </p>
                      <p onClick={() => addSkill(cos?.id, "INTERMEDIATE", cos)}>
                        Intermediate
                      </p>
                      <p onClick={() => addSkill(cos?.id, "ADVANCED", cos)}>
                        Advanced
                      </p>
                    </div>
                  </div>
