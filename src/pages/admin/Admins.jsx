...
import {
  UseGetAllAdmins,
  useGetAllEmployees,
} from "../../graphql/query/useGetAllEmployees";
import iDelW from "../../assets/iDelW.png";
    ...
    <>
      <div className="category">
        ...
        <div
          className="s-icon"
          onClick={() =>
            setAdmin({ ...admin, open: true, email: "", isAdmin: null })
          }
        >
          <p>Add New</p>
          <img
            ...
            <div style={{ padding: 20 }}>
              <div className="ce-head" style={{ marginBottom: "40px" }}>
                ...
                <img
                  ...
                  onClick={() =>
                    setAdmin({ open: false, email: "", isAdmin: null })
                  }
                  src={
                    "https://img.icons8.com/ios/48/fc3737/delete-sign--v1.png"
                  }
                  alt=""
                />
              </div>
              <div className="ce-body">
                <input
                  ...
                  onChange={(e) =>
                    setAdmin({ ...admin, email: e.target.value, isAdmin: true })
                  }
                />
                <datalist id="employees">
                  {employees?.map(
                    (e) =>
                      !e.isAdmin && <option value={e?.email}>{e?.name}</option>
                  )}
                </datalist>
                {loading && (
        ...
        {gettingAdmins || gettingEmployees ? (
          <div
            ...
            {displayAdmins?.map((a) => (
              <div className="admin-card" key={a?.id}>
                <img
                  style={
                    a?.photo
                      ...
                      : { padding: "10px", width: "30px", height: "30px" }
                  }
                  src={a?.photo ? a?.photo : iAdminW}
                  alt=""
                />
                <div className="ac-cont">
                  ...
                  >
                    <p>{a?.name}</p>
                    <span style={{ fontSize: "smaller", color: "#ff000068" }}>
                      {a?.email}
                    </span>
                  </div>
                  {a?.id !== user?.id && (
